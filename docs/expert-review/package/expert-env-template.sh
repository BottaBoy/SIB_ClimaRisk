...
export SIB_RISK_HAZARD_SURGE_TOPO_PATH_GUADELOUPE="${SIB_RISK_HAZARD_SURGE_TOPO_PATH_GUADELOUPE:-${UPLOADS_ROOT}/DEM_Topo/Topo/Guadeloupe.tif}"
export SIB_RISK_HAZARD_SURGE_TOPO_PATH_MARTINIQUE="${SIB_RISK_HAZARD_SURGE_TOPO_PATH_MARTINIQUE:-${UPLOADS_ROOT}/DEM_Topo/Topo/Martinique.tif}"
export SIB_RISK_HAZARD_SURGE_TOPO_PATH="${SIB_RISK_HAZARD_SURGE_TOPO_PATH:-${SIB_RISK_HAZARD_SURGE_TOPO_PATH_GUADELOUPE}}"
...
# Legacy precomputed hazard archives (optional for archaeology; production scientific runs do not use them).
...
export SIB_RISK_ALLOW_CLIMADA_FALLBACK="${SIB_RISK_ALLOW_CLIMADA_FALLBACK:-false}"
export SIB_RISK_HAZARD_PREFER_DYNAMIC_FROM_PARQUET="${SIB_RISK_HAZARD_PREFER_DYNAMIC_FROM_PARQUET:-true}"
export SIB_RISK_HAZARD_FALLBACK_TO_PRECOMPUTED="${SIB_RISK_HAZARD_FALLBACK_TO_PRECOMPUTED:-false}"
export SIB_RISK_CLIMADA_STRICT_REQUIRED_COMPONENTS="${SIB_RISK_CLIMADA_STRICT_REQUIRED_COMPONENTS:-true}"
...
[expert-env] SURGE_TOPO_GUADELOUPE=${SIB_RISK_HAZARD_SURGE_TOPO_PATH_GUADELOUPE}
[expert-env] SURGE_TOPO_MARTINIQUE=${SIB_RISK_HAZARD_SURGE_TOPO_PATH_MARTINIQUE}
